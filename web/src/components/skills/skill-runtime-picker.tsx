...
export function SkillRuntimePicker({
    skills,
    loading,
    value,
    onChange,
    placeholder = "选择本次生成使用的技能",
    profile = "canvas",
}: {
    skills: Skill[];
    loading?: boolean;
    ...
    const options = useMemo(() => skills.map((skill) => ({ value: skill.skill_id, label: skill.skill_name, title: skill.description })), [skills]);
