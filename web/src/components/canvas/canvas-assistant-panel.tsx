...
const ONLINE_READ_TOOLS = new Set([
    ...skillRuntime.agentToolNames("onlineAgent"),
    "canvas_get_state",
    "canvas_get_context",
    "canvas_find_nodes",
    "canvas_get_node",
...
const ONLINE_AGENT_TOOLS: ResponseFunctionTool[] = [
    ...
    toolDefinition("canvas_find_nodes", "按标题、内容、提示词、类型、状态或资产检索真实节点。", {
        query: { type: "string" },
        ids: { type: "array", items: { type: "string" } },
