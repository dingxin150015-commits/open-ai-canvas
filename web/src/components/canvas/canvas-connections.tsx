...
export const ConnectionPath = React.memo(
    function ConnectionPath({
        ...
        return (
            <g>
                ...
                {showEmphasis ? <path d={pathD} stroke={theme.accent.primary} strokeWidth="8" vectorEffect="non-scaling-stroke" strokeOpacity={0.18} fill="none" strokeLinecap="round" style={{ pointerEvents: "none", filter: "blur(3px)" }} /> : null}
                <path
    ...
    (previous, next) =>
        ...
        previous.hideVisual === next.hideVisual &&
