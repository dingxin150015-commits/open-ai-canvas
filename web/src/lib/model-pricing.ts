...
export function modelQuoteRequest(config: AiConfig, value: string, capability?: ModelCapability, requirements?: ModelRequirements): { modelID: string; intent: ModelRequestIntent } | undefined {
