...
export type EditorSlotPermissionVerdict = { allowed: true } | { allowed: false; reason: "plugin-not-registered" | "missing-permission"; missing: EditorPluginPermission | null };
