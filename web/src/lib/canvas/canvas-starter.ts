...
export function resolveCanvasEmptyStateKind({ nodeCount, shortDramaEnabled, isProjectLinked, starterMode }: { nodeCount: number; shortDramaEnabled: boolean; isProjectLinked: boolean; starterMode?: CanvasStarterMode }): CanvasEmptyStateKind {
