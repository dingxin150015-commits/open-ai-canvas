        ...
        <main className="app-user-content app-workspace-canvas app-workspace-scroll h-full overflow-y-auto text-foreground">
            <div className="app-home-workbench w-full px-4 pb-12 pt-5 sm:px-6 lg:px-8">
                {loadingUserWorkspace ? (
                    ...
                    <ReturningWorkspace summary={activeProject} detail={activeProjectQuery.data} recentProjects={domainProjects.slice(0, 5)} recentIndependentCanvases={recentIndependentCanvases} onCreateIndependentCanvas={createIndependentCanvas} />
                ) : (
        ...
        <>
            ...
            <section className="app-home-template-rail border-t border-border/80 py-7" aria-label="工作流入口">
                <div className="mb-4 flex items-end justify-between gap-4">
                    <div>
                        <h2 className="text-base font-semibold">从工作流开始</h2>
                        <p className="mt-1 text-xs leading-5 text-foreground/48">整理故事 → 确认设定 → 制作镜头 → 检查结果。</p>
                    </div>
