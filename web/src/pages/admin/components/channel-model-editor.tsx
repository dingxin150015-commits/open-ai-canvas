...
import { isChannelModelReadOnly } from "./channel-model-support";
...
export function ChannelModelEditor({
    ...
    const readOnly = isChannelModelReadOnly(editing);
    ...
    return (
        <Modal
            ...
            title={
                <div className="admin-model-editor-title">
                    <span>{readOnly ? "查看模型" : editing ? "编辑模型" : "新增模型"}</span>
                    <p>
                ...
                <div className="admin-model-editor-footer-actions">
                    ...
                    <div className="admin-model-editor-footer-primary">
                        <Button
                            ...
                            loading={testing}
                            disabled={readOnly || saving || protocolLoading || Boolean(protocolError)}
                        ...
                        <Button type="primary" loading={saving} disabled={readOnly || testing || protocolLoading || Boolean(protocolError)} onClick={() => void save()}>
                            {editing ? "保存修改" : "添加模型"}
                        </Button>
                    </div>
                </div>
        ...
        >
            <Form className="admin-model-editor-form" form={form} initialValues={initialValues} layout="vertical" disabled={busy || readOnly} inert={busy || readOnly} onValuesChange={handleFormValuesChange}>
