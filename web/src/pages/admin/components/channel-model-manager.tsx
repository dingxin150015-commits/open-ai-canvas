...
import { deleteAdminChannelModel, deleteAdminChannelModels, fetchAdminChannelModels, importAdminChannelModels, listAdminChannelModels, type ChannelModel, type ChannelModelPriceTier, type ChannelModelSupportStatus } from "@/services/api/wallet";
            ...
            <AdminDataTable
                ...
                table={{
                    ...
                    rowSelection: {
                        ...
                        getCheckboxProps: (item) => ({ disabled: isChannelModelReadOnly(item) || deletingSelected }),
