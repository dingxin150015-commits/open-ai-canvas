...
import { chapterStoryboardAssets, chapterStoryboardCharacters, chapterStoryboardReplaceImpact, storyboardRowsToProjectShots } from "@/pages/projects/detail/chapter-storyboard-production";
...
function storyboardRow(): StoryboardRow {
    return {
        ...
        plotDescription: "林默推门进入雨夜的旧屋。",
        dialogue: "林默：有人吗？",
        characters: [{ characterName: "林默", characterAssetId: "character-1", characterVersionId: "character-version-1" }],
        narrativeIntent: "建立悬念",
        viewerPOV: "跟随林默",
        performanceBlocking: "林默谨慎推门并环顾室内",
        shotSize: "中景",
        emotion: "戒备",
        lightingAndAtmosphere: "冷色月光与室内暖光交界",
        audioEffects: "雨声与木门摩擦声",
        camera: "平视，35mm",
        motion: "缓慢推进",
        timeBeats: "0-2 秒推门；2-5 秒环顾",
        imageGenerationPrompt: "雨夜旧屋中的林默",
        videoMotionPrompt: "林默推门，镜头缓慢推进",
        mustHave: [],
        optionalDetails: [],
        continuityOut: "林默停在门内，右手仍扶着门把",
        negativePrompt: "画面文字",
        ...
        assets: [
            {
                ...
                category: "character",
                status: "ready",
                primaryVersionId: "asset-version-1",
                versionCount: 1,
                usages: [],
                position: 0,
                updatedAt: "",
                character: { versionId: "character-version-1", version: 1, definition: { appearance: "黑色风衣" }, representations: [], visualStatus: "ready", voiceStatus: "missing" },
            },
