...
- [ ] 按 `UPSTREAM_MERGE_PLAN_20260828.md` 完成官方上游增量合并；固定 `4f07daa` 的冲突解决和阶段 12C 完整跨栈验证已通过，当前等待用户单独批准本地 merge commit。官方新尾差 `4f07daa..0893741`（2 提交、122 文件）不在当前范围，需未来独立审计；push 仍需更后授权。
