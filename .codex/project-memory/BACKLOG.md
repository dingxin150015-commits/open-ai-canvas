...
- [ ] 用户Edge清空DevTools后复验首页/创作/项目/画布/分镜无17371刷屏和报价400。
- [ ] 复验项目/自由画布暗色点网格，并通过新入口进入导演台执行F6。
...
- [ ] 用户使用登录态Microsoft Edge完成F6及视觉/Runtime/报价/加载稳定性验收。
- [ ] Edge通过后再同步远程候选并决定阶段9稳定晋升；当前远程候选仍aff2c8e5。
