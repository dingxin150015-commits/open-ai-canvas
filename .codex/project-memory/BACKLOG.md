...
- [ ] 按 `UPSTREAM_MERGE_PLAN_20260828.md` 完成官方上游增量合并；阶段 0-9 的冲突解决和全量验证已由本地 merge commit `d04c4d1` 固化。阶段 10 复核发现官方 `main` 已前进到 `80d2aa6`，相对 `115e228` 新增 11 个提交和 96 个文件，已按门禁停止；需先完成新增量审计并取得用户批准。push 仍需单独批准。
